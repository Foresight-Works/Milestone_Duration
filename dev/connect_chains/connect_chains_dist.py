...
while chain_pairs:
	...
	def se_connected_chains(es_pair):
		#es_pair, chains_end, chains_start = pair_chains
	...
	#pairs_chains = [(es_pair, chains_end, chains_start) for es_pair in es_pairs]
	for connected_chains in map(se_connected_chains, es_pairs):
		#batch += 1
		#chains_dict[batch] = connected_chains
		print(len(connected_chains))
