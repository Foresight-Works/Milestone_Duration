...
s = ['a', 'b', 'c']
encoder = strings_encoder(s)
print('encoder:', encoder)
text_string_code = string_encoder('d', encoder)
print('text_string, code:', text_string_code)
encoder = update_encoder(encoder, text_string_code)
print('updated encoder:', encoder)
